...
// https://luckyresistor.me/2019/07/29/use-enum-with-more-class/
enum class PhysicalLayer {Ethernet, WiFi, HardwareSerial, HardwareSerial1, HardwareSerial2, HardwareSerial3, SoftwareSerial, };
enum class TransportLayer {UDP, TCP, };
enum class ApplicationLayer {MQTT, HTTP, };
